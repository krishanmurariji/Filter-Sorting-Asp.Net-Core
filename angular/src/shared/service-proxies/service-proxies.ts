...
@Injectable()
export class UserDetailServiceServiceProxy {
    private http: HttpClient;
    private baseUrl: string;
    protected jsonParseReviver: ((key: string, value: any) => any) | undefined = undefined;
    ...
    getUserDetails(): Observable<UserDetailsDto[]> {
        let url_ = this.baseUrl + "/api/services/app/UserDetailService/GetUserDetails";
        url_ = url_.replace(/[?&]$/, "");
     ...
     * @return Success
     */
    getNames(): Observable<Int64NameValueDto[]> {
        let url_ = this.baseUrl + "/api/services/app/UserDetailService/GetNames";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return _observableThrow(e) as any as Observable<Int64NameValueDto[]>;
                }
            } else
                return _observableThrow(response_) as any as Observable<Int64NameValueDto[]>;
        }));
    }

    protected processGetNames(response: HttpResponseBase): Observable<Int64NameValueDto[]> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
        ...
        if (status === 200) {
            ...
            if (Array.isArray(resultData200)) {
                result200 = [] as any;
                for (let item of resultData200)
                    result200.push(Int64NameValueDto.fromJS(item));
            }
            else {
                result200 = <any>null;
            }
     ...
     * @return Success
     */
    getEmails(): Observable<Int64NameValueDto[]> {
        let url_ = this.baseUrl + "/api/services/app/UserDetailService/GetEmails";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetEmails(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<Int64NameValueDto[]>;
                }
            } else
    ...
    protected processGetEmails(response: HttpResponseBase): Observable<Int64NameValueDto[]> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
     ...
     * @return Success
     */
    getGenders(): Observable<Int32NameValueDto[]> {
        let url_ = this.baseUrl + "/api/services/app/UserDetailService/GetGenders";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return _observableThrow(e) as any as Observable<Int32NameValueDto[]>;
                }
            } else
                return _observableThrow(response_) as any as Observable<Int32NameValueDto[]>;
        }));
    }

    protected processGetGenders(response: HttpResponseBase): Observable<Int32NameValueDto[]> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
        ...
        if (status === 200) {
            ...
            if (Array.isArray(resultData200)) {
                result200 = [] as any;
                for (let item of resultData200)
                    result200.push(Int32NameValueDto.fromJS(item));
            }
            else {
                result200 = <any>null;
            }
     ...
     * @return Success
     */
    getMaritalStatus(): Observable<Int32NameValueDto[]> {
        let url_ = this.baseUrl + "/api/services/app/UserDetailService/GetMaritalStatus";
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processGetMaritalStatus(response: HttpResponseBase): Observable<Int32NameValueDto[]> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
     ...
     * @return Success
     */
    get(id: number | undefined): Observable<UserDetailsDto> {
        let url_ = this.baseUrl + "/api/services/app/UserDetailService/Get?";
        if (id === null)
            throw new Error("The parameter 'id' cannot be null.");
        else if (id !== undefined)
            url_ += "Id=" + encodeURIComponent("" + id) + "&";
    ...
    protected processGet(response: HttpResponseBase): Observable<UserDetailsDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
     ...
     * @return Success
     */
    getAll(keyword: string | undefined, skipCount: number | undefined, maxResultCount: number | undefined): Observable<UserDetailsDtoPagedResultDto> {
        let url_ = this.baseUrl + "/api/services/app/UserDetailService/GetAll?";
        if (keyword === null)
            throw new Error("The parameter 'keyword' cannot be null.");
        else if (keyword !== undefined)
            url_ += "Keyword=" + encodeURIComponent("" + keyword) + "&";
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return _observableThrow(e) as any as Observable<UserDetailsDtoPagedResultDto>;
                }
            } else
                return _observableThrow(response_) as any as Observable<UserDetailsDtoPagedResultDto>;
        }));
    }

    protected processGetAll(response: HttpResponseBase): Observable<UserDetailsDtoPagedResultDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = UserDetailsDtoPagedResultDto.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap((_responseText: string) => {
     ...
     * @return Success
     */
    create(body: UserDetailsDto | undefined): Observable<UserDetailsDto> {
        let url_ = this.baseUrl + "/api/services/app/UserDetailService/Create";
        url_ = url_.replace(/[?&]$/, "");
     ...
     * @return Success
     */
    update(body: UserDetailsDto | undefined): Observable<UserDetailsDto> {
        let url_ = this.baseUrl + "/api/services/app/UserDetailService/Update";
        url_ = url_.replace(/[?&]$/, "");
     ...
     */
    delete(id: number | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/UserDetailService/Delete?";
        if (id === null)
            throw new Error("The parameter 'id' cannot be null.");
        else if (id !== undefined)
            url_ += "Id=" + encodeURIComponent("" + id) + "&";
...
export class Int64NameValueDto implements IInt64NameValueDto {
    name: string | undefined;
    value: number;

    constructor(data?: IInt64NameValueDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): Int64NameValueDto {
        data = typeof data === 'object' ? data : {};
        let result = new Int64NameValueDto();
        result.init(data);
        return result;
    }
...
export interface IInt64NameValueDto {
    name: string | undefined;
    value: number;
}
...
export class UserDetailsDtoPagedResultDto implements IUserDetailsDtoPagedResultDto {
    items: UserDetailsDto[] | undefined;
    totalCount: number;

    constructor(data?: IUserDetailsDtoPagedResultDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): UserDetailsDtoPagedResultDto {
        data = typeof data === 'object' ? data : {};
        let result = new UserDetailsDtoPagedResultDto();
        result.init(data);
        return result;
    }
    ...
    clone(): UserDetailsDtoPagedResultDto {
        const json = this.toJSON();
        let result = new UserDetailsDtoPagedResultDto();
        result.init(json);
        return result;
...
export interface IUserDetailsDtoPagedResultDto {
    items: UserDetailsDto[] | undefined;
    totalCount: number;
}
